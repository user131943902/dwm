...
static const unsigned int borderalpha = 0xFF; /* border alpha */
...
/* commands */
static const char *termcmd[]  = { "sh", "-c", "cd \"$HOME\" && exec " TERMINAL, NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_Return,     spawn,                  {.v = (const char*[]){ FILEMANAGER, NULL } } },
	{ MODKEY|ShiftMask,		XK_w,          spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "nmtui", NULL } } },
	{ MODKEY,			XK_l,          spawn,                  {.v = (const char*[]){ "xsecurelock", NULL } } },
